"""JavaScript Language Resolver implementing LanguageResolverPort."""
...
from ria.resolution.language.javascript.extractor import JavaScriptExtractor


class JavaScriptLanguageResolver(LanguageResolverPort):
    """Language resolver implementation for JavaScript code."""
