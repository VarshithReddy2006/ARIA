"""TypeScript Language Resolver implementing LanguageResolverPort."""
...
from ria.resolution.language.typescript.extractor import TypeScriptExtractor


class TypeScriptLanguageResolver(LanguageResolverPort):
    """Language resolver implementation for TypeScript code."""
