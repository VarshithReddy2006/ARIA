...
class Planner(PlannerPort):
    ...
    def create_plan(
        ...
        s1 = ExecutionStep(
            ...
            parameters={"repo_id": goal.repo_id, "query": goal.description},
        )
        s2 = ExecutionStep(
            step_id="step_2",
            tool_name="find_definition",
            parameters={"repo_id": goal.repo_id, "symbol_moniker": ""},
        )
        s3 = ExecutionStep(
            step_id="step_3",
            tool_name="build_context",
            parameters={"repo_id": goal.repo_id, "question": goal.description},
        )
        s4 = ExecutionStep(
            step_id="step_4",
            tool_name="ask_repository",
            parameters={"repo_id": goal.repo_id, "question": goal.description},
        )
