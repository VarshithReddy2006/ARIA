...
class IncrementalScheduler(IncrementalSchedulerPort):
    ...
    def __init__(
        ...
        cache_invalidator: CacheInvalidatorPort,
    ...
    def execute_plan(self, plan: IncrementalPlan) -> bool:
        ...
        self._logger.info(
            "Executing IncrementalScheduler plan", repo_id=plan.repo_id.repo_id.value
        )
        ...
        try:
            ...
            if plan.files_to_reindex:
                file_units = self._scanner.scan_incremental(
                    ws_dir, plan.files_to_reindex
                )
                ...
                for fu in file_units:
                    ...
                    pu = self._builder.build_parse_unit(
                        fu, parser_result, parse_duration
                    )
            ...
            self._logger.error(
                ...
                exc=err,
                repo_id=plan.repo_id.repo_id.value,
            )
            return False
