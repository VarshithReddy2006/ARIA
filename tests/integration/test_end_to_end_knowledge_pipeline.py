"""End-to-End Integration Test for C8 Knowledge Layer Pipeline & Performance Targets."""
...
def test_full_knowledge_layer_end_to_end_pipeline(tmp_path: Path) -> None:
    """End-to-End Pipeline & Performance Verification Test for C8 Knowledge Layer:
    Git -> Sync -> Index -> Resolve -> FactStore -> ContextBuilder -> KnowledgeEngine.
    """
