"""Unit tests for ImpactAnalysisService (Phase 6)."""
...
def test_impact_analysis_service() -> None:
    ...
    impact = svc.analyze_impact(twin, ("src/app.py",))

    assert "src/app.py" in impact.target_files
    assert "src/app.py" in impact.affected_files
