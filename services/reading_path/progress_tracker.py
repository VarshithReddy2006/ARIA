...
def get_user_progress(
    completed_steps: List[str], total_steps: int = 15
) -> Dict[str, Any]:
        ...
        badges.append(
            {
                ...
                "description": "Completed first repository step",
            }
        )
    if completed_count >= 3:
        badges.append(
            {
                "badge_id": "b2",
                "name": "Entry Points Mastered",
                "description": "Mastered application entry points",
            }
        )
    if completed_count >= 6:
        badges.append(
            {
                "badge_id": "b3",
                "name": "Routing & Services Expert",
                "description": "Explored API routing and service orchestration",
            }
        )
        ...
        badges.append(
            {
                ...
                "description": "Covered 70%+ of repository layers",
            }
        )
