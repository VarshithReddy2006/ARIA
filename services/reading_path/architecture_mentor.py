...
LAYER_GUIDANCE = {
    "Presentation": {
        ...
        "responsibilities": ["Input validation", "HTTP status routing", "Request deserialization"],
        "common_mistakes": ["Direct database calls inside routers", "Embedding business rules in controllers"],
        "best_practices": ["Delegate logic to Application Service layer", "Use strict DTO schemas"],
        "related_patterns": ["MVC", "Facade"],
    },
    "Application": {
        "purpose": "Orchestrates use-cases and coordinates domain workflow execution.",
        "responsibilities": ["Transaction boundary management", "Use-case orchestration", "Security checks"],
        "common_mistakes": ["Coupling directly to database drivers", "Leaking domain entities to UI"],
        "best_practices": ["Depend on abstraction interfaces", "Keep handlers focused on single use-case"],
    ...
    "Domain": {
        ...
        "common_mistakes": ["Importing UI or framework packages", "Adding IO database operations"],
        "best_practices": ["Keep domain framework-agnostic", "Cover 100% with unit tests"],
    ...
    "Infrastructure": {
        ...
        "responsibilities": ["Database queries", "HTTP client calls", "FileSystem operations"],
        "common_mistakes": ["Bypassing interface contracts", "Exposing connection objects"],
        "best_practices": ["Implement domain interface ports", "Handle retry and timeout resiliency"],
